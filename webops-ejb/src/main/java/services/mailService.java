...
public class mailService {
	...
	public static void Send(final String username, final String password, String recipientEmail, String title,
			String message) throws AddressException, MessagingException, UnsupportedEncodingException {
		mailService.Send(username, password, recipientEmail, "", title, message);
	}
	...
	public static void Send(final String username, final String password, String recipientEmail, String ccEmail,
			String title, String message) throws AddressException, MessagingException, UnsupportedEncodingException {
		...
		msg.setFrom(new InternetAddress("pidevmail25@gmail.com","WebOps"));
		...
		t.connect("smtp.gmail.com", "pidevmail25@gmail.com", "20104702esT.");
